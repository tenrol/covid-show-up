...
import { PatientCaseComponent } from 'app/entities/patient-case/patient-case.component';
...
describe('Component Tests', () => {
  describe('PatientCase Management Component', () => {
    let comp: PatientCaseComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(PatientCaseComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.patientCases && comp.patientCases[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
